...
trexio_exit_code trexio_s3_unlock(trexio_t* const file);
...
trexio_s3_init (trexio_t* const file)
{
  ...
  trexio_exit_code rc;
  rc = trexio_s3_inquire(file->file_name);
...
/* TODO
  rc = trexio_s3_free_$group$( (trexio_s3_t*) file);
*/
...
trexio_s3_flush (trexio_t* const file)
{
  ...
  rc = trexio_s3_flush_$group$(f); if (rc != TREXIO_SUCCESS) return rc;

...
character(len = 12) :: TREXIO_PACKAGE_VERSION = "2.5.1"
integer :: TREXIO_VERSION_MAJOR = 2
integer :: TREXIO_VERSION_MINOR = 5
integer :: TREXIO_VERSION_PATCH = 1
character(len = 64) :: TREXIO_GIT_HASH = "192e415a8fdb532331caff139feaa6015dc4da94"
...
interface
   integer(trexio_exit_code) function trexio_has_pbc_madelung (trex_file) bind(C)
     import
     integer(trexio_t), intent(in), value :: trex_file
...
interface
   integer(trexio_exit_code) function trexio_read_pbc_madelung_32 (trex_file, num) bind(C)
     import
     integer(trexio_t), intent(in), value :: trex_file
     real(c_float), intent(out) :: num
...
interface
   integer(trexio_exit_code) function trexio_read_pbc_madelung_64 (trex_file, num) bind(C)
     import
     integer(trexio_t), intent(in), value :: trex_file
     real(c_double), intent(out) :: num
...
interface
   integer(trexio_exit_code) function trexio_read_pbc_madelung (trex_file, num) bind(C)
     import
     integer(trexio_t), intent(in), value :: trex_file
     real(c_double), intent(out) :: num
...
interface
   integer(trexio_exit_code) function trexio_write_pbc_madelung_32 (trex_file, num) bind(C)
     import
     integer(trexio_t), intent(in), value :: trex_file
     real(c_float), intent(in), value :: num
...
interface
   integer(trexio_exit_code) function trexio_write_pbc_madelung_64 (trex_file, num) bind(C)
     import
     integer(trexio_t), intent(in), value :: trex_file
     real(c_double), intent(in), value :: num
...
interface
   integer(trexio_exit_code) function trexio_write_pbc_madelung (trex_file, num) bind(C)
     import
     integer(trexio_t), intent(in), value :: trex_file
     real(c_double), intent(in), value :: num
...
integer(trexio_exit_code) function trexio_write_metadata_package_version (trex_file, str, max_str_len)
  ...
  trexio_write_metadata_package_version = trexio_write_metadata_package_version_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_metadata_description (trex_file, str, max_str_len)
  ...
  trexio_write_metadata_description = trexio_write_metadata_description_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_nucleus_point_group (trex_file, str, max_str_len)
  ...
  trexio_write_nucleus_point_group = trexio_write_nucleus_point_group_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_state_current_label (trex_file, str, max_str_len)
  ...
  trexio_write_state_current_label = trexio_write_state_current_label_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_basis_type (trex_file, str, max_str_len)
  ...
  trexio_write_basis_type = trexio_write_basis_type_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_basis_oscillation_kind (trex_file, str, max_str_len)
  ...
  trexio_write_basis_oscillation_kind = trexio_write_basis_oscillation_kind_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_basis_interpolator_kind (trex_file, str, max_str_len)
  ...
  trexio_write_basis_interpolator_kind = trexio_write_basis_interpolator_kind_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_grid_description (trex_file, str, max_str_len)
  ...
  trexio_write_grid_description = trexio_write_grid_description_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_mo_type (trex_file, str, max_str_len)
  ...
  trexio_write_mo_type = trexio_write_mo_type_c(trex_file, trim(str) // c_null_char, max_str_len)
...
integer(trexio_exit_code) function trexio_write_jastrow_type (trex_file, str, max_str_len)
  ...
  trexio_write_jastrow_type = trexio_write_jastrow_type_c(trex_file, trim(str) // c_null_char, max_str_len)
